...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.79"
  WORKING_DIRECTORY "/home/wyz/CLionProjects/VolumeRenderer/cmake-build-release/_deps/imgui-src"
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/wyz/CLionProjects/VolumeRenderer/cmake-build-release/_deps/imgui-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/wyz/CLionProjects/VolumeRenderer/cmake-build-release/_deps/imgui-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
